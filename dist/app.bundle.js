...
/***/ function(module, exports, __webpack_require__) {
	...
	btnStream$.subscribe(function (event) {
	    console.log('clicked:', event, event.target.innerHTML);
	}, function (error) {
	    console.log(error);
	}, function () {
	...
	_Rx2.default.Observable.fromEvent(input, 'keyup').subscribe(function (event) {
	 ...
	 * Observable from Events
	 */
	var documentStream$ = _Rx2.default.Observable.fromEvent(document, 'mousemove');
	documentStream$.subscribe(function (e) {
	...
	var nums = [1, 2, 3, 4, 5];
	_Rx2.default.Observable.from(nums).subscribe(function (v) {
	    console.log(v);
	}, function (err) {
	    console.log(err);
	}, function () {
	...
	_Rx2.default.Observable.from(colors).subscribe(function (v) {
	    console.log(v);
	}, function (err) {
	    console.log(err);
	}, function () {
